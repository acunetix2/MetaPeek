...
export default function LandingPage() {
  ...
  useEffect(() => {
    const interval = setInterval(() => setIndex((prev) => (prev + 1) % screenshots.length), 3000);
  ...
  return (
    <div className="bg-gray-900 text-white font-sans">
      {/* Navbar */}
      <header className="flex justify-between items-center px-8 py-4 border-b border-gray-800 shadow-md bg-gray-900 sticky top-0 z-50">
        <div className="flex items-center gap-6">
          <h1 className="text-2xl font-bold text-green-500 hover:text-green-400 transition cursor-pointer">
            MetaPeek
          </h1>
          <nav className="flex items-center gap-6">
            <a href="#features" className="hover:text-green-400 transition">Features</a>
            <a href="#screenshots" className="hover:text-green-400 transition">Demo</a>
            <a href="#howitworks" className="hover:text-green-400 transition">Workflow</a>
          </nav>
        </div>
      ...
      <section className="text-center py-16 px-6">
        <h2 className="text-4xl md:text-6xl font-extrabold mb-4">
          See Beyond the Surface with <span className="text-green-500">MetaPeek</span>
        </h2>
        <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-6">
          Discover hidden details and metadata in images instantly. MetaPeek is your professional suite for
          forensic image analysis, anomaly detection, and structured reporting—designed for teams that need
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-gray-400 mb-3">
              Experience real-time visual forensics and metadata parsing. MetaPeek detects hidden edits,
              flags anomalies, and surfaces the facts—so you can act with confidence.
            </p>
            <p className="text-gray-400">
              From compliance reviews to investigative workflows, MetaPeek translates raw image data into
              reliable insights and shareable reports.
            </p>
      ...
      <section id="features" className="py-16 px-8 bg-gray-800">
        <h3 className="text-3xl font-bold text-center mb-10">Why Choose MetaPeek?</h3>
      ...
      <section id="howitworks" className="py-16 px-8 bg-gray-800">
        <h3 className="text-3xl font-bold text-center mb-10">How MetaPeek Works</h3>
      ...
      <section className="text-center py-10 px-8 bg-green-900">
        <h3 className="text-3xl font-bold mb-3 text-white">Ready to Elevate Your Image Analysis?</h3>
        <p className="text-gray-200 mb-4 max-w-2xl mx-auto">
          Join teams that rely on MetaPeek for faster reviews, defensible findings, and clean reports.
        </p>
	...
	<footer className="bg-gray-900 text-gray-400 py-12 mt-12 px-6 md:px-12 lg:px-24">
	  <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 text-left">
		...
		<div>
		  ...
		  <p className="mb-6">Uncover hidden details, detect anomalies, and gain actionable insights from images.</p>
		...
		<div>
		  ...
		  <div className="flex gap-4 text-2xl">
			<a href="https://twitter.com/metapeek" target="_blank" className="hover:text-green-500 transition">
			  <FaTwitter />
			</a>
			<a href="https://linkedin.com/company/metapeek" target="_blank" className="hover:text-green-500 transition">
			  <FaLinkedin />
			</a>
			<a href="https://github.com/metapeek" target="_blank" className="hover:text-green-500 transition">
			  <FaGithub />
			</a>
		  </div>
		</div>
	  ...
	  <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 px-6 md:px-12 lg:px-24">
		...
		<p className="text-center md:text-right">© {new Date().getFullYear()} MetaPeek. All rights reserved.</p>
	  </div>
	</footer>
    </div>
  );
